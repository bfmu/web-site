      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <div class="space-y-3">
          <button
            ...
            class="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-gray-50 text-gray-500">O regístrate con email</span>
          </div>
        </div>
